...
// com as fotos reais de produto do próprio catálogo
// ---------------------------------------------------------------------
const FAMILIAS = [
  { slug: "startflow", nome: "StartFlow", funcao: "Repõe água em reservatórios. Comando por nível.", count: 3, img: "assets/produtos/familia-startflow.png" },
  { slug: "startpress", nome: "StartPress", funcao: "Acompanha o consumo e controla a pressão da rede.", count: 3, img: "assets/produtos/familia-startpress.png" },
  { slug: "startfire", nome: "StartFire", funcao: "Atende à demanda da rede preventiva de incêndio.", count: 2, img: "assets/produtos/familia-startfire.png" },
  { slug: "startdrain", nome: "StartDrain", funcao: "Retira líquido acumulado. A versão ETE bombeia efluentes.", count: 2, img: "assets/produtos/familia-startdrain.png" },
  { slug: "construction", nome: "Construction", funcao: "Pressuriza a rede provisória da obra.", count: 1, img: "assets/produtos/familia-construction.png" },
];
...
const PRODUTOS = [
  {
    ...
    img: "assets/produtos/startflow-h-compact.png",
  ...
  },
  {
    ...
    img: "assets/produtos/startflow-plus-v.png",
  ...
  },
  {
    ...
    img: "assets/produtos/startflow-prime-v.png",
  ...
  },
  {
    ...
    img: "assets/produtos/startpress-h-compact.png",
  ...
  },
  {
    ...
    img: "assets/produtos/startpress-plus-v.png",
  ...
  },
  {
    ...
    img: "assets/produtos/startpress-prime-v.png",
  ...
  },
  {
    ...
    img: "assets/produtos/startfire-eej.png",
  ...
  },
  {
    ...
    img: "assets/produtos/startfire-edj.png",
  ...
  },
  {
    ...
    img: "assets/produtos/startdrain.png",
  ...
  },
  {
    ...
    img: "assets/produtos/startdrain-ete.png",
  ...
  },
  {
    ...
    img: "assets/produtos/startpress-construction.png",
  ...
  familiasGrid.innerHTML = FAMILIAS.map(
    ...
    <button type="button" class="familia-teaser" data-familia="${f.slug}" style="text-align:left;border:none;font:inherit;cursor:pointer;">
      ...
      <div class="familia-teaser-body">
        ...
        <h3>${f.nome}</h3>
        <p>${f.funcao}</p>
        <span class="familia-arrow">Ver sistemas <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M5 12h14M13 6l6 6-6 6"/></svg></span>
      </div>
    </button>`
  ).join("");
  familiasGrid.querySelectorAll(".familia-teaser").forEach((card) => {
